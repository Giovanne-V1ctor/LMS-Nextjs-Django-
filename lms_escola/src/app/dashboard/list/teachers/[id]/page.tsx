            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="bg-[#C3EBFA] py-6 px-4 rounded-md flex-1 flex gap-4">
                    ...
                    <div className="w-2/3 flex flex-col justify-between gap-4">
                        <h1 className="text-xl font-semibold">Johnathan Dover</h1>
        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                    <Link className="p-3 rounded-md bg-[#EDF9FD]" href="/">Teacher's Classes</Link>
                    <Link className="p-3 rounded-md bg-[#F1F0FF]" href="/">Teacher's Students</Link>
                    <Link className="p-3 rounded-md bg-[#FEFCE8]" href="/">Teacher's Lessons</Link>
