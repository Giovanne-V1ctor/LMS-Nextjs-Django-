        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                    <Link className="p-3 rounded-md bg-[#EDF9FD]" href="/">Student's Lessons</Link>
                    <Link className="p-3 rounded-md bg-[#F1F0FF]" href="/">Student's Teachers</Link>
                    ...
                    <Link className="p-3 rounded-md bg-[#FEFCE8]" href="/">Student's Results</Link>
                </div>
            </div>
            <Performance/>
            <Announcements/>
